...
const AnimateMusic = () => {
    return (
        <svg width="34" height="100%" viewBox="0 0 60 40" xmlns="http://www.w3.org/2000/svg" fill="var(--primary)">
            ...
            <rect x="12" width="8" y="10" height="30">
            ...
            <rect x="36" width="8" y="10" height="30">
